...
OptionParser.parse do |parser|
  ...
  parser.on("-no", "--no-output", "run the program without generating output to the terminal (use -l to get the info)") { no_output = true }
