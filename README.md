...
time-it is an application for timing another application. this is a crystal implementation. the basis for this is my original [python implementation](https://github.com/elliethepuppy/time-it)
...
in order to call `time-it` from anywhere, you'll need to add it to your PATH. you can do this any number of ways, so i'll leave you to deciding the best for you.
